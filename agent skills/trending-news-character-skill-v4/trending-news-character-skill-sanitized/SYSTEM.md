...
Add captions after the final top/bottom assembly and lower-third title are complete.
Use stable JetBrains Mono 3-word captions with active-word neon cyberpunk red highlighting (`#ff003c`) and no default popping/scaling animation, placed just above the HyperFrames ticker after assembly without shrinking the centered 960x890 HyperFrames safe zone.
