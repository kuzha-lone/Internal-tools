...
2. Put in your own:
   - X bearer token
   - HeyGen API key
   - ElevenLabs API key only if you turn on ElevenLabs voice or want ElevenLabs Scribe instead of the default HyperFrames/Whisper caption fallback
...
- keep captions enabled for the default JetBrains Mono timed caption pipeline
