...
- inside that 1080x960 top-half viewport, the mandatory safe zone for HyperFrames assets and infographics is the 960x890 primary animation zone
- all primary HyperFrames assets, infographics, charts, maps, and animations must fit inside that 960x890 zone; only background texture, glows, and non-essential decoratives may live outside it
...
- compose with a center-weighted dense hero frame inside the 1080x960 top-half viewport: the most important board/chart/map/photo/stat cluster should occupy the middle of the 960x890 safe zone, with supporting elements organized around it
- do not leave the middle hollow, pin the whole scene to the top, or use giant empty panels that do not carry information
...
- do not design scenes bottom-only either; the center of the safe zone must still carry the beat
...
- do not compose major cards, headlines, maps, charts, labels, or stat blocks against the outer edges of the square source just because the source render is 1080x1080; the composition truth is the 1080x960 viewport with a 960x890 primary animation safe zone
